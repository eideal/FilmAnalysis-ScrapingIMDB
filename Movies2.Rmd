...
table$TicketsSold[14] <- strsplit(table$TicketsSold[14], ' ')[[1]][3]
...
table$FormatTitle[33] <- 'Ghost%20Busters'

# Around the World in 80 Days written "Eighty"
table$FormatTitle[48] <- 'Around%20The%20World%20In%20Eighty%20Days'

# National Lampoon's Animal House is called 'Animal House' in IMDB
table$FormatTitle[59] <- 'Animal%20House'

# M*A*S*H is written MASH in IMDB
table$FormatTitle[86] <- 'MASH'
```
